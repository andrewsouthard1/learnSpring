package com.andrewsouthard.servlet.demo;
...
import com.andrewsouthard.service.demo.WelcomeService;
...
public class WelcomeServletNew extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<String> welcomeMessage = welcomeService.getWelcome("Andrew Southard");
